    ...
    <AnimatePresence>
      {open ? (
        <div className="fixed inset-0 z-50 grid place-items-center p-4">
          ...
          />
          <motion.section
            className="relative z-10 flex max-h-[calc(100dvh-2rem)] w-full max-w-lg min-w-0 flex-col overflow-hidden rounded-lg border border-[#D8E5EC] bg-white shadow-[0_24px_80px_rgba(24,35,43,0.22)]"
