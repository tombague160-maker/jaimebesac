...
const variants: Record<ButtonVariant, string> = {
  primary:
    "border-strong bg-strong text-on-strong shadow-[0_10px_24px_rgba(24,35,43,0.18)] hover:opacity-90",
  secondary:
    "border-blue-soft bg-blue-wash text-ink shadow-[inset_0_-1px_0_rgba(94,173,211,0.2)] hover:bg-blue-wash-2",
  ghost:
    "border-transparent bg-transparent text-muted hover:bg-surface hover:text-ink",
  danger: "border-danger-border bg-danger-soft text-rose-text hover:bg-danger-border",
};
  ...
  return (
    <button
      ...
      className={cn(
        ...
        "focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-blue/20",
        variants[variant],
        sizes[size],
        className,
      )}
